...
chmod +x $HOME/r2-v0.1.0-alpha/r2

if [ "$EUID" -eq 0 ]; then
	mv $HOME/r2-v0.1.0-alpha/r2 /usr/bin/r2
	rm -r $HOME/r2-v0.1.0-alpha
else
	echo "Couldn't add r2 to /usr/bin because script is not running at admin"
	echo "Please run the following commands:"
	echo "  mv $HOME/r2-v0.1.0-alpha/r2-${OS}-${ARCH} /usr/bin/r2"
	echo "  rm -r $HOME/r2-v0.1.0-alpha"
fi
